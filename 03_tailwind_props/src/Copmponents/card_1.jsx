...
function New_card(){
    ...
    <div className="flex font-sans">
      <div className="flex-none w-56 relative">
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2d/SPDC_figure.png/800px-SPDC_figure.png" alt="" className="absolute inset-0 w-full h-full object-cover rounded-lg" loading="lazy" />
      </div>
      <form className="flex-auto p-6">
        <div className="flex flex-wrap">
          <h1 className="flex-auto font-medium text-slate-900">
            Quantum Experiment Kit
          </h1>
